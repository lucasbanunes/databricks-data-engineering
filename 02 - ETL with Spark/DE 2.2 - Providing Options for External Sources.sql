...
-- MAGIC %python
-- MAGIC files = dbutils.fs.ls(DA.paths.sales_csv)
-- MAGIC display(files)
...
-- MAGIC %python
-- MAGIC import os
-- MAGIC repo_dir, _ = os.path.split(os.getcwd())
-- MAGIC copy_path = os.path.join("FileStore", "sales-csv-000.csv")
-- MAGIC copy_path
-- MAGIC dbutils.fs.cp(os.path.join(DA.paths.sales_csv, "000.csv"), copy_path)
