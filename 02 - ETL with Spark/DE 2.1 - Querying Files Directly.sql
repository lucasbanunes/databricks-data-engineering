...
-- MAGIC %python
-- MAGIC dbutils.fs.cp("/mnt/dbacademy-datasets/data-engineer-learning-path/v01/ecommerce/raw/events-kafka/000.json",
-- MAGIC               "FileStore/events-kafka-example-000.json")

-- COMMAND ----------

-- MAGIC %python
-- MAGIC file_store_files = dbutils.fs.ls("FileStore")
-- MAGIC display(file_store_files)
...
-- The variable "DA.paths.kafka_events" is a parameter defined on hive
...
-- MAGIC 
-- MAGIC This is the main difference between views and CTE's
