...
-- Even though it reads from parquet files the data is stored as delta table values 
...
-- MAGIC %python
-- MAGIC display(dbutils.fs.ls("/mnt/dbacademy-users/lucasbanunes@gmail.com/data-engineer-learning-path/database.db/events"))
